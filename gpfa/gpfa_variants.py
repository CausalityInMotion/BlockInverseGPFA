...
class GPFASerialBlockInv(GPFA):
    """
    GPFA with incremental computation of the inverse of the kernel matrix,
    but with no parallelization during parameter learning.
    """
...
class GPFASerialLinalgInv(GPFA):
    """
    GPFA with non-incremental computation of the inverse of the
    kernel matrix using `numpy.linalg.inv` and with no parallelization
    for gradient computation during parameter learning.
    """
...
class GPFASerialPersymInv(GPFA):
    """
    GPFA with Elephant's tridiagonal solver for block persymmetric kernel
    matrix inversion and and with no parallelization for gradient
    computation during parameter learning.
    """
...
class GPFAThreadedLinalgInv(GPFA):
    """
    GPFA with non-incremental computation of the inverse of the
    kernel matrix using `numpy.linalg.inv`, but with parallelization
    for gradient computation during parameter learning.
    """
...
class GPFAThreadedPersymInv(GPFA):
    """
    GPFA with Elephant's tridiagonal solver for block persymmetric kernel
    matrix inversion and parallelization for gradient computation during
    parameter learning.
    """
